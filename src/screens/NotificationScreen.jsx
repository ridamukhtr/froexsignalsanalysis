      ...
      <CustomScrollView>
        <View style={[globalStyles.alert, { marginBottom: 10, }]}>
          <CustomText style={{ color: COLORS.DANGER_RED }}>
            Favourite List Notification
          </CustomText>
          <CustomText style={{ color: COLORS.DANGER_RED }}>
            You will get alert only from your favorite list.
          </CustomText>
        </View>
        ...
        {data?.length > 0 ? (
          ...
          <CustomText>
            Your favorite list is empty. You can only get notification alert from your fav list.
            To add currency/stock in your fav list, click on "Star" ⭐ icon, that show on main screen before currency/stock name
          </CustomText>
        )}
      </CustomScrollView>
    </CustomView >

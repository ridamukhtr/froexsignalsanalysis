...
const ViewIndicesRating = () => {
    return (
        <View style={{ backgroundColor: COLORS.DARK_BLUE, padding: 20, }}>
            ...
            <View style={{paddingHorizontal:40, flexDirection:"row", alignItems:"center", gap:6 }}>
                <Icon name="clockcircle" size={15} color={COLORS.YELLOW} />
                <CustomText style={globalStyles.timeText}>{"13/6 - Delayed Currency in FRC"}</CustomText>
